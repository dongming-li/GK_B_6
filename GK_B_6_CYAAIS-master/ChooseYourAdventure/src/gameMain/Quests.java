...
public class Quests {
	 ...
	 * Quest updater.
	 *
	 * @param questTask the quest task
	 */
	...
	public void checkTutorial() {
		...
		if(checkTasks[0] == 1 && checkTasks[1] == 1 && checkTasks[2] == 1) {
			if(!(pc.getRow() == 92 && pc.getCol() == 164) || (pc.getRow() == 89 && pc.getCol() == 169) ) {
				...
				connect.sendAndReceive("INSERT into DoneQuests (Username, QuestID) VALUES (\'" + pc.getUsername() + "\', 1)", null);
	...
	public void checkAcademic2() {
		...
		if(checkTasks[3] == 1 && checkTasks[7] == 1 && checkTasks[8] == 1 ) {
	...
	public void checkBre2() {
		/*
		 * Obtain a stress level below 40
		 * 		checkTasks[54] = 1;
		 */
		if(pc.getStress() <= 40)
			checkTasks[54] = 1;
	...
	public void checkAcademic4() {
		 ...
		 * 		checkTasks[7] > 0;
		 */
		if(pc.getBullyCount() >= 10)
			checkTasks[7] = 1;
		
		/*
		 * If the player passed their Exam
		 * 		checkTasks[9] > 0;
		 */
		if(questTasks[9] == 1)
			checkTasks[9] = 1;
		...
		if(checkTasks[3] == 1 && checkTasks[7] == 1 && checkTasks[8] == 1 ) {
			connect.sendAndReceive("INSERT DoneQuests (Username, QuestID) VALUES (\'" + pc.getUsername() + "\', 21)", null);
			connect.sendAndReceive("DELETE FROM CurrentQuests where Username = \'" + pc.getUsername() + "\' AND QuestID = 21", null);
			connect.sendAndReceive("update Statistics set Experience = " + (pc.getXP() + 40) + " where Username = \'" + pc.getUsername() + "\'", null);
			pc.giveXP(40);
